...
export function AiAnalyticsPage() {
  ...
  return (
    <AppShell active="analytics" className="pb-20">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <button
          ...
          onDrop={onDrop}
          className={`mt-8 flex w-full max-w-xl flex-col items-center rounded-2xl border-2 border-dashed px-6 py-12 transition backdrop-blur-xl ${
            dragOver
              ? 'border-[#5f7f6a] bg-white/50'
              : 'border-white/50 bg-white/25 hover:border-white/70'
        ...
        {snapshot ? (
          <div className="mt-12 space-y-8">
            ...
            <section>
              ...
              <ul className="mt-4 space-y-3">
                {snapshot.sections.map((row) => (
                  <li
                    key={row.label}
                    className="rounded-xl border border-white/40 bg-white/25 px-4 py-3 backdrop-blur-xl"
                  >
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <section className="rounded-2xl border border-[#cfe5d6]/40 bg-emerald-50/30 p-5 backdrop-blur-lg sm:p-6">
              ...
              <section className="rounded-2xl border border-[#fecaca]/40 bg-red-50/30 p-5 backdrop-blur-lg sm:p-6">
            ...
            <details className="rounded-xl border border-white/30 bg-white/20 p-4 text-sm backdrop-blur-lg">
