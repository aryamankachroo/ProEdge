  ...
  return (
    <AppShell active="diagnostic">
      <div className="mx-auto max-w-3xl px-4 py-3 sm:px-8">
        ...
        <div className="mt-2 h-1 overflow-hidden rounded-full bg-white/40">
          <div
      ...
      <main className="mx-auto max-w-3xl px-4 py-6 pb-28 sm:px-8 sm:py-8 sm:pb-32">
        ...
        <div className="mt-8 rounded-2xl border border-white/40 bg-white/25 p-6 shadow-[0_8px_32px_rgba(31,38,135,0.15)] backdrop-blur-xl sm:p-8">
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-start gap-3 rounded-xl border px-4 py-3.5 text-left text-sm leading-snug transition sm:gap-4 sm:py-4 ${
                    isOn
                      ? 'border-[#5f7f6a] bg-white/70 ring-1 ring-[#5f7f6a]/35'
                      : 'border-white/40 bg-white/30 hover:bg-white/45'
                  }`}
                >
                  <span
                    className={`mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full border text-xs font-bold ${
                      isOn
                        ...
                        : 'border-[#c9bfb4] bg-white/80 text-[#5c534c]'
                    }`}
                  >
                    {(['A', 'B', 'C', 'D'] as const)[i]}
                  </span>
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-20 border-t border-white/30 bg-white/45 px-4 py-4 pb-[calc(1rem+env(safe-area-inset-bottom,0px))] backdrop-blur-2xl sm:px-8">
