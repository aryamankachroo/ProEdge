    ...
    return (
      <div className="onboarding-shell relative min-h-dvh">
        ...
        <div className="relative z-10 mx-auto flex min-h-dvh max-w-2xl flex-col px-5 py-10 md:px-8 md:py-14">
          ...
          <section className="mb-8 rounded-[1.75rem] border border-white/70 bg-white/65 p-8 text-center shadow-[0_12px_48px_-16px_rgba(90,70,55,0.14)] backdrop-blur-md md:p-10">
  ...
  return (
    <div className="onboarding-shell relative min-h-dvh">
      ...
      <div className="relative z-10 mx-auto flex min-h-dvh max-w-3xl flex-col px-5 pb-28 pt-6 md:px-8 md:pb-16 md:pt-8">
        ...
        <section className="rounded-[1.75rem] border border-white/70 bg-white/65 p-6 shadow-[0_12px_48px_-16px_rgba(90,70,55,0.14)] backdrop-blur-md md:p-8">
          {question.passage ? (
            <div className="mb-6 rounded-2xl border border-[#ebe3d9] bg-[#faf7f3]/80 p-5 text-sm leading-relaxed text-[#4a423c]">
              {question.passage}
            </div>
          ) : null}
                ...
                <li key={i}>
                  <button
                    ...
                    className={`flex w-full rounded-2xl border-2 px-4 py-4 text-left text-sm font-semibold leading-snug transition-all md:px-5 md:py-4 md:text-[0.95rem] ${
                      on
                        ? 'border-[#5f7f6a] bg-[#f0f5f1] text-[#2d3f32] shadow-[0_4px_20px_-8px_rgba(95,127,106,0.3)]'
                        : 'border-transparent bg-white/90 text-[#4a423c] shadow-sm hover:border-[#e8dfd4]'
                    }`}
                  >
                    <span
        ...
        <div className="fixed bottom-0 left-0 right-0 z-20 border-t border-[#e8dfd4]/80 bg-[#faf7f3]/90 px-5 py-4 pb-[calc(1rem+env(safe-area-inset-bottom,0px))] backdrop-blur-lg md:static md:mt-10 md:border-0 md:bg-transparent md:p-0 md:pb-0 md:backdrop-blur-none">
