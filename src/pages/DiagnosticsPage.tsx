      ...
      <div className="relative z-10 mx-auto max-w-3xl px-5 py-10 sm:px-8 sm:py-14">
        ...
        {!importFlow ? (
          ...
          <>
            ...
            <p className="mt-3 text-sm leading-relaxed text-[#7a6e66]">
              {pdfName ?
                <>File: <strong className="text-[#3d3835]">{pdfName}</strong></>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              ...
              {busy ? (
                <span className="text-sm text-[#7a6e66]">Analyzing with Gemini…</span>
              ) : null}
            </div>
            ...
            {report ? (
              <div className="mt-10 rounded-2xl border border-[#e8dfd4] bg-white/90 p-5 shadow-sm sm:p-8">
                <DiagnosticImportedReportView report={report} />
              </div>
            ) : (
              <div className="mt-10 rounded-2xl border border-dashed border-[#d4c9be] bg-white/60 p-8 text-center">
                ...
                <p className="mt-3 text-xs text-[#9a8b7e]">
                  Requires <code className="rounded bg-[#f5f0eb] px-1">VITE_GEMINI_API_KEY</code>{' '}
                  in <code className="rounded bg-[#f5f0eb] px-1">.env.local</code>.
                </p>
              </div>
            )}
          </>
